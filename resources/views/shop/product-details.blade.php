              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{ asset($productDetails->image) }}" width="674"
                      height="674" alt="" />
                    <a data-fancybox="gallery" target="_blank" href="{{ asset($productDetails->image) }}" data-bs-toggle="tooltip"
                  ...
                  @foreach ( explode(',', $productDetails->images) as $gimg)
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto" src="{{ asset($gimg) }}" width="674"
                      height="674" alt="" />
                    <a data-fancybox="gallery" href="{{ asset($gimg) }}" data-bs-toggle="tooltip"
                      data-bs-placement="left" title="Zoom">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <use href="#icon_zoom" />
                      </svg>
              ...
              <div class="swiper-container">
                ...
                <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto"
                      src="{{ asset($productDetails->image) }}" width="104" height="104" alt="" />
                </div>
                @foreach ( explode(',', $productDetails->images) as $gimg)
                <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="h-auto"
                      src="{{ asset($gimg) }}" width="104" height="104" alt="" />
                </div>
                @endforeach
        ...
        <div class="col-lg-5">
          ...
          <div class="product-single__price">
            <span class="current-price">
                ...
                <s>${{ $productDetails->regular_price }}</s> ${{ $productDetails->sale_price }}
                @else
          ...
          @auth
          <form name="addtocart-form" method="post" action="{{ route('add-to-cart') }}">
            @csrf
            <div class="product-single__addtocart">
              ...
              @else
              <input type="hidden" name="price" value="{{ $productDetails->regular_price }}">
              @endif
        ...
        <div class="tab-content">
          <div class="tab-pane fade show active" id="tab-description" role="tabpanel"
            ...
            <div class="product-single__description">
              <h3 class="block-title mb-4">{{ $productDetails->name }}</h3>
    ...
    <section class="products-carousel container">
      ...
      <div id="related_products" class="position-relative">
        <div class="swiper-container js-swiper-slider" data-settings='{
          ...
          <div class="swiper-wrapper">
            @forelse ($relatedPeoducts as $relatedProduct)
            <div class="swiper-slide product-card">
                <div class="pc__img-wrapper">
                  <a href="{{ route('shop.product.details', $relatedProduct->slug) }}">
                    <img loading="lazy" src="{{ asset($relatedProduct->image) }}" width="330" height="400"
                      alt="Cropped Faux leather Jacket" class="pc__img">
                    @foreach (explode(',', $relatedProduct->images) as $gimg)
                    <img loading="lazy" src="{{ asset($gimg) }}" width="330" height="400"
                ...
                <div class="pc__info position-relative">
                  ...
                  <div class="product-card__price d-flex">
                    <span class="money price">
                        ...
                        <s>${{ $relatedProduct->regular_price }}</s> $ {{ $relatedProduct->sale_price }}
                        @else
